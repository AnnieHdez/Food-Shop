...
export class AuthService {
    ...
    signup(email: string, password: string) {
        return this.http
            .post<AuthResponseData>(
                'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCElP-cTMXI8Ue0u0U_HcV56EvZ_77tpU8',
                {
                    email: email,
                    password: password,
    ...
    login(email: string, password: string) {
        return this.http.post<AuthResponseData>(
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCElP-cTMXI8Ue0u0U_HcV56EvZ_77tpU8',
            {
                email: email,
                password: password,
                returnSecureToken: true,
